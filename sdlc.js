...
const implementation ="Writing the actual code of the system that is being created"
const testingIntegration ="A type of software testing in which the different unit, modules or components of a software application are tested as a combinded entity."
const Maintain ="The process of changing, modifying and updating software."